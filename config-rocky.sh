...
sudo yum install rsync bind-utils mlocate wget openldap-clients make cmake automake man net-tools ntsysv nfs-utils yum-utils postfix s-nail zip unzip telnet chrony git lsof curl -y
